       ...
       /// <summary>
        ...
        private UIWindow CreateInstance<T>() where T : UIWindow , new()
        {
            ...
            if (attribute != null)
            {
                ...
                window.Init(type.FullName, attribute.WindowLayer, attribute.FullScreen, assetName, attribute.FromResources, attribute.HideTimeToClose, attribute.PackageName);
            }
            else
            {
